...
export function WeaknessList({ masteryData }: WeaknessListProps) {
  ...
  const getMasteryColorClass = (score: number) => {
    ...
    if (score < 70) return 'bg-[hsl(45,100%,95%)] text-[hsl(45,100%,30%)] border-[hsl(45,100%,80%)]';
    return 'bg-[hsl(142,70%,95%)] text-[hsl(142,70%,35%)] border-[hsl(142,70%,80%)]';
  };
